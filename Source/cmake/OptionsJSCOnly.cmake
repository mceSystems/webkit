...
if (CUSTOM_ICU)
    if (NOT ICU_INCLUDE_DIRS AND DEFINED ENV{ICU_INCLUDE_DIRS})
        set(ICU_INCLUDE_DIRS "$ENV{ICU_INCLUDE_DIRS}" CACHE "" INTERNAL FORCE)
    endif ()
    if (NOT ICU_LIBRARIES AND DEFINED ENV{ICU_LIBRARIES})
        set(ICU_LIBRARIES "$ENV{ICU_LIBRARIES}" CACHE "" INTERNAL FORCE)
    endif ()

    if (NOT ICU_COMPILER_FLAGS AND DEFINED ENV{ICU_COMPILER_FLAGS})
        set(ICU_COMPILER_FLAGS "$ENV{ICU_COMPILER_FLAGS}" CACHE "" INTERNAL FORCE)
        add_definitions(${ICU_COMPILER_FLAGS})
    endif ()
